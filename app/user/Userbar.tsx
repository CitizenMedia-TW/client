...
export default function Userbar() {
  ...
  const userInfo = "Lorem ipsum dolor sit amet consectetur. Orci commodo pharetra vestibulum eleifend semper. Mi risus enim velit nulla quis fermentum feuac. Nisi morbi fermentum feugiat "
                    ...
                    <div className="flex flex-row justify-between m-4">
                      <div className="">
                        {story.tags.map((tag, tagIndex) => (
                          (tagIndex % 3 === 0) &&
                          <div key={tagIndex} className="flex items-center mb-4 gap-2">
                            {[tagIndex, tagIndex + 1, tagIndex + 2].map(index => (
                              index < story.tags.length &&
                              <div key={index} className="rounded-3xl bg-gray-200 hover:bg-gray-100 hover:-translate-y-1">
                                <div className="flex justify-center items-center">
                                  <p className="text-[10px] m-1">{story.tags[index]}</p>
                                </div>
                              </div>
                            ))}
                          </div>
                      ...
                      <div className="h-24 w-4/12 bg-slate-800 flex mx-4 mb-4">
